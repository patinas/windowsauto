...
choco install zerotier-one googlechrome teamviewer 7zip vlc adobereader winrar googledrive sharex obsidian pandoc autohotkey powertoys mailspring brave putty -y
