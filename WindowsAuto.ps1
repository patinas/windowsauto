...
choco install tailscale zerotier-one googlechrome 7zip vlc adobereader winrar googledrive sharex obsidian pandoc autohotkey powertoys brave putty tabby etcher -y
